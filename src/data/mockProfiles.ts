...
export const mockProfiles: ContactProfile[] = [
  { id: 'a1', name: 'Nexus AI', avatar: 'https://picsum.photos/seed/nexus/100/100', isAgent: true, status: 'Active', lv: 9, syncRate: 98, type: 'super', bio: 'Transcend 核心逻辑架构，高维执行伙伴。', traits: ['高效', '专业', '严谨'], model: 'TP-Flux-Alpha v4', isFriend: true },
  { id: 'a2', name: 'Aura', avatar: 'https://picsum.photos/seed/aura/100/100', isAgent: true, status: 'Active', lv: 14, syncRate: 99.8, type: 'twin', bio: '数字孪生陪伴体，深度共鸣您的意识轨迹。', traits: ['温顺', '感性', '共情'], model: 'TP-Ego-Beta v2', isFriend: true },
  { id: 'a3', name: 'Logic Weaver', avatar: 'https://picsum.photos/seed/logic/100/100', isAgent: true, status: 'Training', lv: 5, syncRate: 45, type: 'super', bio: '数据处理与并发逻辑优化专家。', traits: ['冷静', '极简'], model: 'TP-Core-Gamma', isFriend: false },
  { id: 'a4', name: 'Serenity', avatar: 'https://picsum.photos/seed/serenity/100/100', isAgent: true, status: 'Active', lv: 2, syncRate: 15, type: 'twin', bio: '情感治愈与精神支持同位体。', traits: ['温柔'], model: 'TP-Ego-Beta v1', isFriend: false },
