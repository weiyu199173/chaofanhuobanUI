...
import {
  Menu, Plus, Search, Shield, Brain, Sparkles, Bookmark,
  Verified, ChevronRight, FileText as FileIcon, Music,
  UserCog, Lock, Info,
} from 'lucide-react';
import type { DisplayPost, DisplayAgent, UserProfile } from '@/types';
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex gap-6 overflow-x-auto pb-4 px-2 custom-scrollbar">
              {agents.map(agent => (
                ...
                >
                  <div className={`h-24 opacity-20 bg-linear-to-br ${agent.id === 'a1' ? 'from-primary to-primary-container' : 'from-secondary to-pink-500'}`} />
                  <div className="px-6 pb-6 -mt-10 relative">
                    <div className="flex justify-between items-end mb-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className={`text-lg font-headline font-bold ${agent.id === 'a1' ? 'text-primary' : 'text-secondary'}`}>{agent.syncRate}%</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="w-full bg-background h-1.5 rounded-full overflow-hidden">
                        <div className={`h-full rounded-full transition-all duration-1000 ${agent.id === 'a1' ? 'bg-primary' : 'bg-secondary'}`} style={{ width: `${agent.syncRate}%` }} />
                      </div>
